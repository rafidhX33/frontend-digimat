...
export class TimelineComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._differentColorChart('["--vz-primary", "--vz-info", "--vz-success", "--vz-gray-300", "--vz-secondary"]');
    this._multiSeriesTimelineChart('["--vz-primary","--vz-info"]');
    this._advancedTimelineChart('["--vz-primary", "--vz-info", "--vz-gray-300"]');
