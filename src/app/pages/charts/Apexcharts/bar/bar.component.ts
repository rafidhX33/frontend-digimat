...
export class BarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
     ...
     this._customDataLabelsChart('["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info", "--vz-primary-rgb, 0.5", "--vz-gray-300", "--vz-danger-rgb, 0.7", "--vz-warning-rgb, 0.5", "--vz-primary", "--vz-info"]');
     ...
     this._patternedChart('["--vz-primary", "--vz-info", "--vz-success", "--vz-gray-300"]');
