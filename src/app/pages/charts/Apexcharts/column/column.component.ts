...
export class ColumnComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicChart('["--vz-info", "--vz-primary", "--vz-success"]');
    this._columnWithDataChart('["--vz-primary"]');
    this._StackedColumnChart('["--vz-primary", "--vz-success", "--vz-info", "--vz-gray-200"]');
    this._StackedColumn100Chart('["--vz-primary", "--vz-info", "--vz-success"]');
    this._ColumnWithMarkerChart('["--vz-primary", "--vz-success"]');
    this._ColumnWithRotatedChart('["--vz-primary"]');
    this._ColumnWithNagetiveChart('["--vz-primary", "--vz-info", "--vz-success"]');
    this._rangeColumnChart('["--vz-primary", "--vz-info"]');
    this._dynamicQuarterLoadedChart('["--vz-primary", "--vz-success", "--vz-gray-200", "--vz-secondary", "--vz-primary-rgb, 0.6", "--vz-info"]');
    this._dynamicLoadedChart('["--vz-primary", "--vz-success", "--vz-gray-200", "--vz-secondary", "--vz-primary-rgb, 0.6", "--vz-info"]');
    this._distributedColumnChart('["--vz-primary", "--vz-success", "--vz-light", "--vz-secondary", "--vz-info", "--vz-primary-rgb, 0.5", "--vz-danger-rgb, 0.5", "--vz-warning-rgb, 0.5"]')
