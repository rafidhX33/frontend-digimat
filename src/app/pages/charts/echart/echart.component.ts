...
export class EchartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._StepLineChart('["--vz-primary", "--vz-gray-300", "--vz-info"]');
    this._LineYChart('["--vz-primary"]');
    this._BasicBarChart('["--vz-primary"]');
    this._HorizontalBarChart('["--vz-primary", "--vz-info"]');
    this._StackedHorizontalBarChart('["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]');
    this._PieChart('["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]');
